...
<p>Регулируется обычной крестовой отвёрткой.<p>На любую стену или внутри любого короба.`,
      },
      {
         cardId: '1_1_2',
...
<p>Блок из оцинкованной стали в сборе, толщина металла пластины - 2мм, толщина металла зацепа -1 мм.`,
      },
      {
         cardId: '1_1_5',
         ...
         description: `<p>Предназначена для звукоизоляции креплений несущей конструкции, имеет клеющий слой, что значительно упрощает время и комфорт монтажа.
<p>Материал прокладки – термоэластопласт (ТЭП)`,
      },
      {
         cardId: '1_1_6',
      ...
      },
      {
         ...
         description: `<p>Предназначен для сборки поворотных конструкций разных размеров в каркасе профильной инсталляци
<p>Каркас устойчив к провисанию`,
      },
      {
         cardId: '1_1_8',
