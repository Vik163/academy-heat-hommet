...
export const catalog: Catalog[] = [
   ...
   },
   {
      ...
      description:
         'Промышленный крепеж - специальные элементы, используемые для соединения различных деталей и конструкций',
   },
   {
      title: 'Профессиональный крепеж',
      titlePage: 'Хоммет: Профессиональный крепеж от производителя',
      imgL: '../../../assets/images/prof.png',
      description: `Профессиональный крепеж - это надежная и безопасная установка систем водоснабжения, отопления и канализации`,
      titleText:
   ...
   },
   {
      ...
      description:
         'Выбор типа зависит от условий эксплуатации, требованиям герметичности и надежности',
      categories: [
         {
