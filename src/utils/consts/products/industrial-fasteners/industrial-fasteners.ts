...
export const industrialFasteners: Record<CategoryIndustrial, Card[]> = {
   'Промышленный крепеж': [
      ...
      },
      {
         ...
         imgL: 'https://hommet.ru/media/hommet_cache/3d/06/3d06122cf689a2e5e1986eda138284a7.webp',
      ...
      },
      {
         ...
         imgL: 'https://hommet.ru/media/hommet_cache/c4/1d/c41de69e41f1fb2835ddc2863e12325f.webp',
         imgB: 'https://hommet.ru/media/uploads/хомуты/3_универсальное_соединение_хоммет_440.webp',
      },
      {
         cardId: '2_1_7',
         title: 'Кронштейн V-образный с гайкой М8',
         pathname: 'product/v-obraznyi-krepezh-s-gaikoi-m8',
         imgL: 'https://hommet.ru/media/hommet_cache/69/44/6944b6a51a7c4cef7fac6ebe12b80651.png',
      ...
      },
      {
         ...
         imgL: 'https://hommet.ru/media/hommet_cache/27/e0/27e07e3680622e5127033615422c5e23.png',
      ...
      },
      {
         ...
         imgL: 'https://hommet.ru/media/hommet_cache/93/30/9330a510c98a10dabf7a4bb7ad7d4457.png',
